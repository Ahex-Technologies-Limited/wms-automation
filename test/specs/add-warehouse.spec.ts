...
describe('Add Warehouse Functionality', function () {
    ...
    it.only('TC001 Verify that  "No Warehouse Added" text should display initially', async () => {
        await  logInPage.open();
        await logInPage.login('supriyasahoo1399@gmail.com', 'Supriya@12');
    ...
    it.only('TC002 Verify that it should navigate to Add Warehouse page when "Add Warehouse" button is clicked', async () => {
        await  logInPage.open();
        await logInPage.login('supriyasahoo1399@gmail.com', 'Supriya@12');
        await browser.waitUntil(
    ...
    it.only('TC004 Verify that it should successfully add a warehouse', async () => {
        ...
        await AddWarehousePage.selectStatus.setValue('Active');
