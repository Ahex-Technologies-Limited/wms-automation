...
describe('Login Functionality', function () {
    ...
    it('TC002 Verify it should login with valid credentials', async function () {
        await LoginPage.login('supriyasahoo1399@gmail.com', 'Supriya@12'); // Replace with valid email and password
//await waitElementIsVisible(await LoginPage.addWarehouseButton);
        // Add your validation for successful login here
  ...
  //await waitPageToLoad();
    ...
    it('TC003 Verify it should show an error message for invalid email format', async function () {
        await LoginPage.login('invalid-email', 'Supriya@12'); // Invalid email format
    ...
    it.only('TC004 Verify it should show an error message for incorrect password', async function () {
        await LoginPage.login('supriyasahoo1399@gmail.com', 'wrongpassword'); // Incorrect password
  

        // Validate that password error message is displayed
    ...
    it('TC005 Verify it should navigate to create account page when create account link is clicked', async function () {
        ...
        // Validate that the create account page is displayed
    ...
    it('TC006 verify it should show an error message for empty email and password fields', async function () {
        await LoginPage.login('', ''); // Empty email and password

        // Validate that email and password error messages are displayed
    ...
    it('TC007 Verify it should show an error message for unregistered email', async function () {
        await LoginPage.login('unregistered@example.com', 'Supriya@12'); // Unregistered email

        // Validate that unregistered email error message is displayed
