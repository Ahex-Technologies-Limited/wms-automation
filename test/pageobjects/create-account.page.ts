...
class createaccount  extends Page {
    ...
    public get fullnameError() {
        return $('');  // Assuming this is the class for reCAPTCHA error message
    }
    public get companyNameError() {
        return $('/html/body/app-root/app-register/div/div[2]/div/form/div[1]/app-validation-error/div/small');  // Assuming this is the class for reCAPTCHA error message
    }
    public get emailAddressError() {
        return $('body > app-root > app-register > div > div.register-right.relative > div > form > div:nth-child(3) > app-validation-error > div > small');  // Assuming this is the class for reCAPTCHA error message
    }
    public get phoneNumberError() {
        return $('body > app-root > app-register > div > div.register-right.relative > div > form > div:nth-child(4) > app-validation-error > div > small');  // Assuming this is the class for reCAPTCHA error message
    }
